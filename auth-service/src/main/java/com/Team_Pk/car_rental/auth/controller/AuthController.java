...
public class AuthController {
    ...
    @PostMapping("/refresh")
    public Mono<JwtResponse> refresh(@RequestParam("refreshToken") String refreshToken) {
        return authService.refresh(refreshToken);
    }

    @PostMapping("/logout")
    public Mono<Void> logout(@RequestParam("refreshToken") String refreshToken) {
        return authService.logout(refreshToken);
    }

    @PostMapping("/forgot-password")
    public Mono<Void> forgotPassword(@RequestParam("email") String email) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public Mono<User> changeRole(@PathVariable("id") UUID id, @Valid @RequestBody ChangeRoleRequest request) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public Mono<User> changeStatus(@PathVariable("id") UUID id, @Valid @RequestBody ChangeStatusRequest request) {
